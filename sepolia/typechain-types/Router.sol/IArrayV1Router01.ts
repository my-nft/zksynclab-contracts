...
export interface IArrayV1Router01Interface extends utils.Interface {
  functions: {
...
export interface IArrayV1Router01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IArrayV1Router01Interface;
