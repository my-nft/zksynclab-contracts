...
export interface ZklabV1FactoryInterface extends utils.Interface {
  functions: {
    ...
    "getInitCodeHash()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getInitCodeHash",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface ZklabV1Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ZklabV1FactoryInterface;
  ...
  functions: {
    ...
    getInitCodeHash(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    getInitCodeHash(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getInitCodeHash(overrides?: CallOverrides): Promise<PopulatedTransaction>;
