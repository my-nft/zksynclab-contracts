...
export interface IArrayV1FactoryInterface extends utils.Interface {
  functions: {
...
export interface IArrayV1Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IArrayV1FactoryInterface;
