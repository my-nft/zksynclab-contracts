...
export interface IZklabV1FactoryInterface extends utils.Interface {
  functions: {
...
export interface IZklabV1Factory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IZklabV1FactoryInterface;
